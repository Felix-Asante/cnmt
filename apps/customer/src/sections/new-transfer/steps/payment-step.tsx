...
import { STATIC_QUOTE, createReferenceNumber } from "../constants";
    ...
    <div className="space-y-8">
      <header className="max-w-lg space-y-2">
        ...
        <p className="text-[15px] leading-relaxed text-muted">
          Transfer the exact amount and include the reference so we can match
          it quickly.
        </p>
      </header>

      <InformationBanner title="Verified before processing">
        We’ll confirm your payment before sending money to the recipient.
        Most transfers complete within 30 minutes after verification.
      </InformationBanner>
      ...
      <PaymentCard
        ...
        details={[
          ...
          },
          {
            ...
            value: reference || createReferenceNumber(),
            copyable: true,
          },
        ]}
      />
